...
export default function Surat() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-20 animate-fade-in relative p-3 md:p-0">
      ...
      {/* INILAH TOASTER YANG SUDAH DIPERBAIKI TOTAL */}
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-gray-800 pb-6 gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-extrabold text-white uppercase flex items-center">
            <FontAwesomeIcon icon={faEnvelopeOpenText} className="mr-3 text-primary" /> Smart E-Letter Archive
          </h2>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 overflow-y-auto">
          <div className="bg-[#0f172a] border border-white/10 w-full max-w-4xl p-6 md:p-8 rounded-3xl shadow-2xl relative my-8">
            ...
            <h3 className="text-xl font-black text-white uppercase tracking-wider mb-6 flex items-center border-b border-white/10 pb-4">
              <FontAwesomeIcon icon={faRobot} className="mr-3 text-primary" /> Form Dokumen Surat Resmi
            </h3>
                ...
                <div className="flex gap-2 items-end">
                  ...
                  <div className="relative">
                    ...
                    <label htmlFor="upload-lampiran" className="flex items-center justify-center p-3 px-4 rounded-xl border border-dashed bg-black/40 border-primary/50 text-primary hover:bg-primary/20 transition-all cursor-pointer font-bold text-xs" title="Unggah Dokumen Lampiran ke Google Drive">
                       <FontAwesomeIcon icon={formData.file_lampiran ? faPaperclip : faUpload} className="mr-2" /> 
                ...
                letters.map((letter) => (
                  <tr key={letter.id} className="hover:bg-white/5 transition-colors group">
                    ...
                    <td className="px-6 py-4 flex justify-end items-center space-x-2">
                      <button onClick={() => handlePrint(letter)} className="px-3 py-2 bg-blue-600/20 text-blue-400 hover:bg-blue-600 hover:text-white border border-blue-600/30 rounded-lg text-xs font-bold transition-all uppercase">
                        <FontAwesomeIcon icon={faPrint} className="mr-1 md:mr-2" /> <span className="hidden md:inline">Cetak PDF</span>
                      </button>
