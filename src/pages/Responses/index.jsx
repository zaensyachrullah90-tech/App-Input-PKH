                  ...
                  <div className="lg:col-span-1 space-y-4">
                    ...
                    {!isVerifikator && (
                      <div className="bg-black/40 p-5 md:p-6 rounded-2xl md:rounded-3xl border border-white/5 shadow-inner">
                        ...
                        <div className="space-y-4">
                          ...
                          <button type="button" onClick={handleAddVerifyColumn} className="w-full bg-gray-800 hover:bg-gray-700 text-white font-black py-4 rounded-xl uppercase text-xs tracking-widest transition-all shadow-lg mt-2">Buat Header Baru</button>
                        </div>
                      </div>
                    )}
                    ...
                    {!isVerifikator && (
                      <div className="bg-black/40 p-5 rounded-2xl border border-white/5">
                        <h5 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3">Daftar Kolom (Edit/Hapus):</h5>
