...
import Surat from './pages/Surat/index'; // Modul Baru
...
function AppNavigation() {
  ...
  return (
    <div className="flex md:flex-col w-full justify-around md:justify-start md:mt-4 overflow-x-auto hide-scrollbar">
      ...
      {/* MENU BARU: SMART SURAT */}
      <NavItem to="/surat" icon={faEnvelopeOpenText} label="Smart Surat" currentPath={location.pathname} />
        ...
        <Route path="/*" element={
          !session ? <Auth /> : (
            <div className="min-h-screen bg-[#030712] text-gray-200 font-sans flex flex-col md:flex-row overflow-hidden">
              ...
              {/* PERBAIKAN RESPONSIVE LAYOUT (MENCEGAH TERPOTONG DI DESKTOP) */}
